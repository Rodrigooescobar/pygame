...
class Game:
    ...
    def mostrar_intro (self):
        intro_game = Intro_game(self.pantalla)
        intro_game.run()
        #self.new_game()
    ...
    def new_game(self):
        ...
        self.player = Player(self, 1000, self.score, self.lista_proyectil_player)
        self.lista_proyectil_enemy = []
        self.lista_enemy = Enemy.crear_lista_ovnis(self, 2, 14, 80, 100, 100, 0, 10, self.lista_proyectil_enemy)
        # self.enemigos = Enemy(0, 0, 0, 0, [], [])
        # self.lista_enemy = self.enemigos.crear_lista_ovnis(
        #     2, 5, 80, 100, 100, 0, 20, self.lista_proyectil_enemy)
